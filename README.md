...
1. 设计如下图的菜单
   ...
   <img src="attachment:4f3d0bf9cc2294b9df188261ee59b5d2" alt="1.png" style="zoom:80%;" />
...
1. MessageBoxButtons参数的取值
   ...
   <img src="attachment:2ca13a8c46345099125f9f3810f1fa4b" alt="2.png" />
2. MessageBoxIcon参数的取值
   
   ![3.png](attachment:ae24d1bff5fc2463914244a564352508)
   
   其实每个消息框都有一个返回值，是一种DialogResult（对话框返回值）类型，其值也是一个枚举类型，其取值如下表
   
   ![4.png](attachment:acf54d5a4bf070f707bc572a691a37cd)
